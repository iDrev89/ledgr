  ...
  return (
    <div className="min-h-screen relative overflow-hidden bg-zinc-950">
      ...
      <div className="relative z-10 min-h-screen flex flex-col">
        {/* Header — click logo icon 5× to reveal admin form */}
                ...
                <form onSubmit={handleEmailLogin} className="space-y-4">
                  <div className="space-y-1.5">
                    ...
                    <Input
                      ...
                      required
                      disabled={isLoading}
                      className="h-11 text-base border-zinc-200 focus-visible:ring-zinc-900"
                      autoFocus
                    />
                  </div>
                  <div className="space-y-1.5">
                  ...
                  <Button
                    ...
                    className="w-full h-11 bg-zinc-900 hover:bg-zinc-800 text-white font-medium mt-2"
                  >
                    {isLoading && (
